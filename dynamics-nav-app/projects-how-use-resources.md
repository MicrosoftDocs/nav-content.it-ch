...
2. Aprire il batch di registrazioni delle commesse interessato e compilare i campi in base alle esigenze. Selezionare il campo per visualizzare una breve descrizione del campo o il collegamento a ulteriori informazioni.
...
1. Nell'angolo superiore destro, scegliere l'icona **Cerca pagina o report**, immettere **Rettifica costi/Prezzi risorsa**, quindi scegliere il collegamento correlato.
...
1. Nell'angolo superiore destro, scegliere l'icona **Cerca pagina o report**, immettere **Modifiche prezzi risorsa**, quindi scegliere il collegamento correlato.
